...
def check(guess):
    if guess < random_number:
        return '<h1>Too low! Try higher!</h1><img src="https://media.giphy.com/media/jD4DwBtqPXRXa/giphy.gif"/>'
    elif guess > random_number:
        return '<h1>Too high! Try lower!</h1><img src="https://media.giphy.com/media/3o6ZtaO9BZHcOjmErm/giphy.gif"/>'
    else:
